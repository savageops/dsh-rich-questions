...
const PREFLIGHT_INSTRUCTIONS = {
  reroll: 'The user hit "Reroll" before starting: they want the same survey topic and branching intent, rewritten from scratch in clean, simple, well-spoken, competent English — shorter prompts, no jargon or filler, tighter option labels and insights. Call ask_survey again with the rewritten spec; do not ask the user anything first.',
  push: 'The user hit "Push" before starting: they want the survey pushed deeper. Before calling ask_survey again, do aggressive research on how competitors and comparable products/specs solve this problem (use the nsect skill/tool for web research) to gather concrete methods, architecture, and intelligence, and pull in any additional local context that sharpens the questions. Then expand and sharpen the survey: more thorough questions and options, insights grounded in what you found, more branching where it adds precision. Call ask_survey again with the expanded, better-informed spec; do not ask the user anything first.',
  ...
  const questionSchema = {
    ...
    properties: {
      ...
      next: {
        ...
        description: 'Question-level follow-up: used when the user skips, answers free-text, or selects an option that declares no next of its own.',
      },
    },
  }
  return {
